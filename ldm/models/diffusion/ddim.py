...
from images_process.visualizer import save_ddim_visualization
import os
...
class DDIMSampler(object):
    def __init__(self, diffusion, model, schedule="linear", alpha_generator_func=None, set_alpha_scale=None,
                 autoencoder = None, save_pred_every=50, save_pred_folder=None, image_path=None,):
        super().__init__()
        ...
        self.save_pred_every = save_pred_every
        self.save_pred_folder = save_pred_folder
