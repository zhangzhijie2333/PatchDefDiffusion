...
if __name__ == "__main__":
    ...
    parser.add_argument("--DATA_ROOT", type=str,  default="./DATA/pcb", help="path to DATA")
    parser.add_argument("--OUTPUT_ROOT", type=str,  default="OUTPUT", help="path to OUTPUT")

    parser.add_argument("--name", type=str,  default="pcb", help="experiment will be stored in OUTPUT_ROOT/name")
    parser.add_argument("--seed", type=int,  default=123, help="used in sampler")
    parser.add_argument("--local_rank", type=int, default=0)
    parser.add_argument("--yaml_file", type=str,  default="configs/pcb.yaml", help="paths to base configs.")
    ...
    parser.add_argument("--total_iters", type=int,  default=250000, help="")
    parser.add_argument("--save_every_iters", type=int,  default=50000, help="")
